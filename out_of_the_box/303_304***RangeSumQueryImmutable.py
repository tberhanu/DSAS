    ...
    def __init__(self, matrix: List[List[int]]):
        ...
        for r in range(1, ROWS + 1):
            ...
            for c in range(1, COLS + 1):
                # let's add the prefix sum just like in 303
                prefix += matrix[r - 1][c - 1] # since we added extra top_row and left_column
                above = self.dp[r - 1][c] # we need to handle the upper part as well
                self.dp[r][c] = prefix + above
